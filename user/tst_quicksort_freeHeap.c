...
void _main(void)
{
	...
	sys_disable_interrupt();
		...
		/*cprintf("initial free frames: ");
		cprintf("%d", InitFreeFrames );
		cprintf("\n");
		cprintf("free frames: ");
		cprintf("%d", sys_calculate_free_frames());
		cprintf("\n");
		cprintf("modified frames: ");
		cprintf("%d", sys_calculate_modified_frames());
		cprintf("\n");
		cprintf("empty ws: ");
		cprintf("%d", numOFEmptyLocInWS);
		cprintf("\n");*/
